		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAPUI5_TEST",
									"targetURL": "#iprojecttest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"iprojecttest-display": {
								"semanticObject": "iprojecttest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=iprojecttest",
									"url": sap.ui.require.toUrl("iprojecttest")
								}
							}
						}
					}
